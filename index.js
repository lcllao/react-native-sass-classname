...
function parsePath(filePath, nativeExtensionPrefix, extensions) {
    ...
    path.pop();
    var noPrefix = nativeExtensionPrefix === '';
...
function getPrefixExtension(pathObject) {
    var opts = (pathObject.opts || {});
    return opts.prefixExtension || (opts.noNativePrefix ? "" : NATIVE_PREFIX_EXTENSION);
}
...
module.exports = function ({Plugin, types: t}) {
    ...
    function importResolver(path, state) {
        ...
        var extensions = getAllowedExtensions(state);
        var prefixExtension = getPrefixExtension(state);
